<template>
  <div class="manage-employees">
    ...
    <!-- Display available Roles and Skills -->
    <div class="mb-4 text-gray-700 flex justify-between">
      <div>
        <h3 class="font-bold">Available Roles:</h3>
        <p>Admin (0), HeadTrucker (1), Chef (2), Staff (3)</p>
      </div>
      <div>
        <h3 class="font-bold">Available Skills:</h3>
        <p>Cooking (0), Driving (1), Waiter (2), Cleaning (3)</p>
      </div>
    </div>
    ...
    <div v-if="showModal" class="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-10">
      <div class="bg-white p-6 rounded-lg w-1/3">
        ...
        <form @submit.prevent="handleEmployeeSubmit">
          ...
          <!-- More Form Inputs for other employee details -->
